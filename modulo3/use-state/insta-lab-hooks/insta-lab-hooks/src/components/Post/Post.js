...
const Post = (props) => {
  ...
  const [comentando, setComentando] = userState(false);
  const [numeroComentarios, setNumeroComentarios] = userState(0);
  const [comentarios, setComentarios] = userState([]);
